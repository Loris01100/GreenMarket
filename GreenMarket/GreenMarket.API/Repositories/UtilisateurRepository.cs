...
public class UtilisateurRepository : IUtilisateurRepository
{
    ...
    public UtilisateurRepository(GreenMarketDbContext context)
        => _context = context;

    public Task<Utilisateur?> GetByIdAsync(Guid keycloakId)
    ...
    public Task<bool> ExistsAsync(Guid keycloakId)
        => _context.Utilisateurs.AnyAsync(u => u.KeycloakId == keycloakId);
}
